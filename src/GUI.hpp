...
public:
    ...
    vector<string> fitnessFunctionChoices = {"Faces / Dist to middle","Long average edge length", "Short average edge length","Faces * edge length", "Number of faces", "Away from smallest", "Dist. to middle"};
